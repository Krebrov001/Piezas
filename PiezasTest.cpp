...
TEST(PiezasTest, gameState_tie_3)
{
    // This test checks if Piezas::gameState() correctly deals with ties along the rows.
    Piezas game;
...
TEST(PiezasTest, gameState_tie_4)
{
    // This test checks if Piezas::gameState() correctly deals with ties along multiple dimensions.
    Piezas game;

    game.dropPiece(1);  // drop X into [0][1]
    game.dropPiece(0);  // drop O into [0][0]
    game.dropPiece(0);  // drop X itno [1][0]
    game.dropPiece(1);  // drop O into [1][1]
    game.dropPiece(0);  // drop X into [2][0]
    game.dropPiece(2);  // drop O into [0][2]
    game.dropPiece(1);  // drop X into [2][1]
...
TEST(PiezasTest, gameState_win_row)
{
    // This test checks if Piezas::gameState() correctly deals with win in the row.
    Piezas game;
...
TEST(PiezasTest, gameState_win_column)
{
    // This test checks if Piezas::gameState() correctly deals with win in the column.
    Piezas game;
